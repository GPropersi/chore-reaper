...
export default function globalSetup() {
  ...
  wrangler([
    ...
    "INSERT INTO households (id, name, timezone) VALUES (1, 'E2E Household', 'UTC'); " +
      ...
      "INSERT INTO users (id, household_id, email, role, timezone) VALUES (2, 1, 'member-e2e@example.com', 'user', 'Europe/London'); " +
      "INSERT INTO household_members (user_id, household_id, role) VALUES (1, 1, 'admin'); " +
      "INSERT INTO household_members (user_id, household_id, role) VALUES (2, 1, 'user'); " +
